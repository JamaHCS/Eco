...
! function(window, document, undefined) {
  ...
  isSVG || ! function(A, e) {
    ...
    function s(A) {
      A || (A = e);
      var n = o(A);
      return !h.shivCSS || l || n.hasCSS || (n.hasCSS = !!t(A, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), c || d(A, n), A
    }
    var l, c, u = "3.7.3",
      p = A.html5 || {},
  ...
  }("undefined" != typeof window ? window : this, document), Modernizr.addTest("applicationcache", "applicationCache" in window), Modernizr.addTest("blobconstructor", function() {
    try {
      return !!new Blob
    } catch (A) {
      return !1
    ...
    return !!supports
  }), Modernizr.addTest("typedarrays", "ArrayBuffer" in window), Modernizr.addTest("xdomainrequest", "XDomainRequest" in window);
  var supports = !1;
  try {
    supports = "WebSocket" in window && 2 === window.WebSocket.CLOSING
  } catch (e) {}
  Modernizr.addTest("websockets", supports), Modernizr.addTest("webaudio", function() {
    var A = "webkitAudioContext" in window,
      e = "AudioContext" in window;
    return Modernizr._config.usePrefixes ? A || e : e
  }), Modernizr.addTest("cssall", "all" in docElement.style);
  var CSS = window.CSS;
  Modernizr.addTest("cssescape", CSS ? "function" == typeof CSS.escape : !1), Modernizr.addTest("focuswithin", function() {
    try {
  ...
  Modernizr.addTest("supports", newSyntax || oldSyntax), Modernizr.addTest("target", function() {
  ...
  }), Modernizr.addTest("willchange", "willChange" in docElement.style), Modernizr.addTest("classlist", "classList" in docElement), Modernizr.addTest("documentfragment", function() {
    ...
    return A
  }), Modernizr.addTest("picture", "HTMLPictureElement" in window), Modernizr.addTest("es5date", function() {
  ...
  }), Modernizr.addTest("urlsearchparams", "URLSearchParams" in window), Modernizr.addTest("getUserMedia", "mediaDevices" in navigator && "getUserMedia" in navigator.mediaDevices), Modernizr.addTest("framed", window.location != top.location), Modernizr.addTest("atobbtoa", "atob" in window && "btoa" in window, {
    aliases: ["atob-btoa"]
    ...
    return !1
  }), Modernizr.addTest("sharedworkers", "SharedWorker" in window), Modernizr.addTest("webworkers", "Worker" in window);
  ...
  ! function() {
    ...
    try {
      ...
      r || (o = new t, o.append(l), r = o.getBlob()), a = n.createObjectURL(r), i = new Worker(a), i.onmessage = function(A) {
        addTest("blobworkers", s === A.data), e()
      }, i.onerror = A, d = setTimeout(A, 200), i.postMessage(s)
    } catch (c) {
      A()
    }
  }), Modernizr.addAsyncTest(function() {
  ...
  Modernizr.addTest("todataurljpeg", function() {
    ...
    for (var A, e = "background-image:", t = "gradient(linear,left top,right bottom,from(#9f9),to(white));", n = "", r = 0, o = prefixes.length - 1; o > r; r++) A = 0 === r ? "to " : "", n += e + prefixes[r] + "linear-gradient(" + A + "left top, #9f9, white);";
  ...
  }), Modernizr.addTest("hidden", "hidden" in createElement("a")), Modernizr.addTest("outputelem", "value" in createElement("output")), Modernizr.addTest("ruby", function() {
    function A(A, e) {
      var t;
  ...
  }), Modernizr.addTest("progressbar", createElement("progress").max !== undefined), Modernizr.addTest("meter", createElement("meter").max !== undefined), Modernizr.addTest("template", "content" in createElement("template")), Modernizr.addTest("time", "valueAsDate" in createElement("time")), Modernizr.addTest("unknownelements", function() {
    var A = createElement("a");
  ...
  }), Modernizr.addTest("videopreload", "preload" in createElement("video")), Modernizr.addTest("videocrossorigin", "crossOrigin" in createElement("video"));
  ...
  ModernizrProto.atRule = atRule, Modernizr.addAsyncTest(function() {
    ...
    if (A = !("plugins" in navigator && "Shockwave Flash" in navigator.plugins || e), A || isSVG) r(!1);
      ...
      i = function() {
        return t(s), docElement.contains(s) ? (docElement.contains(d) ? (a = d.style.cssText, "" !== a ? r("blocked", d) : r(!0, d)) : r("blocked"), void n(s)) : (s = document.body || s, d = createElement("embed"), d.type = "application/x-shockwave-flash", s.appendChild(d), setTimeout(i, 1e3))
      }, setTimeout(i, 10)
    }
  });
  var mq = function() {
  ...
  Modernizr.inputtypes = function(A) {
    for (var e, t, n, r = A.length, o = "1)", i = 0; r > i; i++) inputElem.setAttribute("type", e = A[i]), n = "text" !== inputElem.type && "style" in inputElem, n && (inputElem.value = o, inputElem.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(e) && inputElem.style.WebkitAppearance !== undefined ? (docElement.appendChild(inputElem), t = document.defaultView, n = t.getComputedStyle && "textfield" !== t.getComputedStyle(inputElem, null).WebkitAppearance && 0 !== inputElem.offsetHeight, docElement.removeChild(inputElem)) : /^(search|tel)$/.test(e) || (n = /^(url|email)$/.test(e) ? inputElem.checkValidity && inputElem.checkValidity() === !1 : inputElem.value != o)), inputs[A[i]] = !!n;
    return inputs
  ...
  Modernizr.addTest("crypto", !!prefixed("subtle", crypto)), Modernizr.addTest("dart", !!prefixed("startDart", navigator)), Modernizr.addTest("forcetouch", function() {
    ...
    var A, e, t, n, r = "detect-blob-support",
      o = !1;
    try {
      A = prefixed("indexedDB", window)
    } catch (i) {}
    ...
    try {
      A.deleteDatabase(r).onsuccess = function() {
        e = A.open(r, 1), e.onupgradeneeded = function() {
          e.result.createObjectStore("store")
        }, e.onsuccess = function() {
          t = e.result;
          try {
            n = t.transaction("store", "readwrite").objectStore("store").put(new Blob, "key"), n.onsuccess = function() {
              o = !0
            }, n.onerror = function() {
              o = !1
            }
  ...
  Modernizr.addTest("getrandomvalues", !!supportsGetRandomValues), Modernizr.addTest("backgroundblendmode", prefixed("backgroundBlendMode", "text")), Modernizr.addTest("objectfit", !!prefixed("objectFit"), {
    ...
    o.innerText = "M", r.style.cssText = "top: 150px; left: 150px; padding: 0px;", i.style.cssText = "width: 50px; height: 50px; padding: 42px;", i.style[A] = a, r.appendChild(o), r.appendChild(i), docElement.appendChild(r);
    var d, s, l = o.getBoundingClientRect();
    return o.style[e] = a, d = o.getBoundingClientRect(), s = parseInt(d.left - l.left, 10), docElement.removeChild(r), 42 == s ? t = !0 : (docElement.appendChild(n), l = n.getBoundingClientRect(), n.style[e] = a, d = n.getBoundingClientRect(), l.height > 0 && l.height !== d.height && 0 === d.height && (t = !0)), o = i = r = n = undefined, t
  ...
  url = url && window[url], Modernizr.addTest("bloburls", url && "revokeObjectURL" in url && "createObjectURL" in url), Modernizr.addAsyncTest(function() {
        ...
        function r(A) {
          try {
            var e, t = createElement("input"),
              ...
              o = !1,
              i = document.body.firstElementChild || document.body.firstChild;
            n.innerHTML = r + A + r, document.body.insertBefore(n, i), document.body.insertBefore(t, n), t.setSelectionRange ? (t.focus(), t.setSelectionRange(0, 0)) : t.createTextRange && (e = t.createTextRange(), e.collapse(!0), e.moveEnd("character", 0), e.moveStart("character", 0), e.select());
            try {
    ...
    }), Modernizr.addTest("userselect", testAllProps("userSelect", "none", !0)), Modernizr.addTest("csstransitions", testAllProps("transition", "all", !0)), Modernizr.addTest("csspseudotransitions", function() {
      var A = !1;
    ...
    }), Modernizr.addTest("variablefonts", testAllProps("fontVariationSettings")), testRunner(), setClasses(classes), delete ModernizrProto.addTest, delete ModernizrProto.addAsyncTest;
